...
var express_validator_1 = require("express-validator"); // midleware
...
app.put("/users/:uuid", userValidationRules, checkForErrors, function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 1:
                _b.trys.push([1, 4, , 5]);
                return [4 /*yield*/, prisma.user.findUnique({ where: { uuid: uuid } })];
            case 2:
                user = _b.sent();
...
app["delete"]("/users/:uuid", function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                _a.trys.push([1, 3, , 4]);
                return [4 /*yield*/, prisma.user["delete"]({ where: { uuid: uuid } })];
            case 2:
                _a.sent();
                return [2 /*return*/, res.json({ message: "User deleted" })];
            case 3:
                error_4 = _a.sent();
                return [2 /*return*/, res.status(404).json({ error: "Something went wrong" })];
...
app.listen(5000, function () { return console.log("Server runing at port 5000"); });
